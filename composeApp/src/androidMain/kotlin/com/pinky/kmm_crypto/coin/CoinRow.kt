...
import com.pinky.kmm_crypto.data.remote.SparklineIn7D
...
fun CoinRow(
    ...
    Column {
        Row(
            ...
            coin?.marketCapRank?.let { Text(it.toInt().toString(), modifier = Modifier.width(30.dp)) }
            ...
            Column(horizontalAlignment = Alignment.End) {
                coin?.currentPrice?.let {
                    Text(
                        it.toCurrencyFormat(maxFractionDigits = 6),
                        style = TextStyle(
